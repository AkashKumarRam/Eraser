                            ...
                            >
                                ...
                                <ul className="mt-6 space-y-2">
                                    ...
                                    <li className="flex items-center gap-1">
                                        ...
                                        <span className="text-gray-700"> Exclusive access to drawer.com content </span>
                                    </li>
                                ...
                                <Link
                                    href="https://www.linkedin.com/in/akash-kumar-ram-b02387252/"
                            ...
                            <div className="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
                                ...
                                <ul className="mt-6 space-y-2">
                                    ...
                                    <li className="flex items-center gap-1">
                                        ...
                                        <span className="text-gray-700"> Limited Access to drawer.com </span>
                                    </li>
